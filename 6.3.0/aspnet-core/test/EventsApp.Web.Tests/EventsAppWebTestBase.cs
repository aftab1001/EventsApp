...
{
    public abstract class EventsAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EventsAppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EventsAppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EventsAppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EventsAppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EventsAppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EventsAppDbContext, Task<T>> func)
        {
            T result;
